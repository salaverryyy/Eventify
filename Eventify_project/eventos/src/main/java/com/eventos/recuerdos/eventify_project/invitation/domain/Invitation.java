...
public class Invitation {
    ...
    private String emailInvitado; // Correo del invitado
    private String estado; // Estado de la invitación (por ejemplo: aceptada, pendiente, rechazada)
    ...
    @ManyToOne
    private Memory recuerdo; // Recuerdo asociado a la invitación
